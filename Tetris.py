...
from GameGrid import Grid  # class for modeling the game grid
...
from Colors import Colors  # used for coloring the game menu
...
class Tetris:
    ...
    def display_game_menu(self, grid_height, grid_width, grid):
        ...
        background_color = Colors(42, 69, 99)
        button_color = Colors(25, 255, 228)
        text_color = Colors(31, 160, 239)
        ...
        # If game is finished, allows user to restart game
            ...
            StdDraw.setPenColor(Colors(232, 38, 38))
